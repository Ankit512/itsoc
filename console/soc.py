...
verdict. The LLM is never imported here: the one advisory surface that may use
it (derive_rca's optional hypothesis) receives a caller-injected callable,
labels its output advisory, and withholds it whenever explanation_guard finds
prose inconsistent with the deterministic facts.
