...
const ASSETS: Asset[] = [
  { id: "asset-ip-203.0.113.44", name: "203.0.113.44", kind: "ip", events: 0, findings: 3, atRisk: true, riskScore: 15, maxSeverity: "HIGH", lastSeen: "2026-08-13T02:18:00+00:00" },
  { id: "asset-host-app-01", name: "app-01", kind: "host", events: 143, findings: 0, atRisk: false, riskScore: 0, maxSeverity: null, lastSeen: null },
];
const USERS: UserEntity[] = [
  { id: "user-admin", name: "admin", events: 6, findings: 1, atRisk: true, riskScore: 5, maxSeverity: "HIGH" },
];
...
describe("Assets page", () => {
  it("renders observed assets and users at risk from real data", async () => {
    ...
    expect(screen.getByText(/1 of 2 asset\(s\) and 1 of 1 user\(s\) at HIGH\+ risk/)).toBeInTheDocument();
  });
