...
- [x] **D3** battle-card + CITATIONS provenance — merged `277daaa`, ceiling framing added. Harness scenario-level P/R/F1 beside arXiv; all-1.0 is regression proof on in-class scenarios, not a general-efficacy claim.
